...
def _get_kappa_aux0(x1, s1, omega, tau, u, z, s, lmbda, hyper):
    ...
    ### rho_prime
    aux = z[:,None] * tau[:,u,:] * omega[None,:,x1]
...
_get_kappa_aux1 = lambda s1, omega, tau, u, z, s, lmbda, hyper: np.sum(omega[s1,:] * _get_kappa_aux0(val_x, s1, omega, tau, u, z, s, lmbda, hyper))
